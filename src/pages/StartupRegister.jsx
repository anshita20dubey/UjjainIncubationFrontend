...
const StartupRegister = () => {
    ...
    // Stage options
    const stageOptions = [
        "Ideation", "Proof of Concept", "Beta Launched", "Early Revenues",
        "Steady Revenues", "Others"
    ];

    // Vertical sector options
    const sectorOptions = [
        "Healthcare", "Agriculture", "Information Technology", "Citizen Services",
        "Social welfare and development", "Education", "Finance", "Transportation",
        "Legal Services", "Technical Services", "Marketing and Advertising",
        "Food and Beverage", "Commercial", "Import and Export", "HR Services", "Other"
    ];
    ...
    const validateForm = () => {
        ...
        if (!formData.summary.trim()) {
            newErrors.summary = 'Product & Services summary is required';
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/api/startups/startup-register', submissionData);
            ...
            setErrors(prev => ({
                ...prev,
                submit: error.response?.data?.message || 'Failed to register startup. Please try again.'
            }));
        } finally {
        ...
        <>
            ...
            <div className="flex justify-center py-12 bg-gray-50">
                <div className="w-full max-w-6xl bg-white rounded-lg shadow-lg p-8 mx-4">
                    <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">Startup Registration</h2>
                    ...
                    {submitSuccess && (
                        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6 mb-8 text-center">
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-gray-700 mb-4">Your startup registration has been successfully submitted. We're excited to have you on our platform!</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 border ${errors.startupName ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400`}
                            ...
                            <div className="mb-4">
                                ...
                                <select
                                    name="stage"
                                    className={`w-full p-3 border ${errors.stage ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 bg-white`}
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 mb-2">
                                    Vertical Sectors <span className="text-gray-400">(Optional)</span>
                                </label>
                                <select
                                    name="sectors"
                                    className={`w-full p-3 border ${errors.sectors ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 bg-white`}
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 mb-2">
                                    DPIIT Registration Number <span className="text-gray-400">(Optional)</span>
                                </label>
                                <input
                                    type="text"
                                    name="dpiitNumber"
                                    placeholder="DPIIT Registration Number"
                                    className={`w-full p-3 border ${errors.dpiitNumber ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400`}
                                    value={formData.dpiitNumber}
                                    onChange={handleChange}
                                />
                                {errors.dpiitNumber && <p className="text-red-500 text-sm mt-1">{errors.dpiitNumber}</p>}
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 border ${errors.website ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400`}
                        ...
                        <div className="mb-6">
                            <label className="block text-gray-700 mb-2">
                                Product & Services Summary <span className="text-red-500">*</span>
                            </label>
                            <textarea
                                name="summary"
                                rows="5"
                                placeholder="Describe your products and services"
                                className={`w-full p-3 border ${errors.summary ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400`}
